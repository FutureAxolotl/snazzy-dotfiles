...
if len(sys.argv) <= 2:
    try:
        ...
        active_text_color = "#5af78e"
        active_underline = "5af78e" if underline is not False else None
        inactive_text_color = "#eff0eb"
        inactive_underline = "#eff0eb" if underline is not False else None
